...
export class XCUITestDriver extends BaseDriver<{
    ...
    static executeMethodMap: {
        ...
        readonly 'mobile: tapWithNumberOfTaps': {
            ...
            readonly params: {
                readonly required: readonly ["elementId", "numberOfTouches", "numberOfTaps"];
            };
        };
        ...
        readonly 'mobile: listCertificates': {
            readonly command: "mobileListCertificates"; /** @type {number|undefined} */
        };
    ...
    getSession(): Promise<{
        ...
        events?: import("@appium/types").EventHistory | undefined;
        error?: string | undefined; /** @type {string[]} */
    } & import("@appium/types").StringRecord & import("@appium/types").StringRecord<any>>;
    deviceCaps: {
        pixelRatio: number;
    ...
    mobileTapWithNumberOfTaps: (this: XCUITestDriver, elementId: string | import("@appium/types").Element<string>, numberOfTouches: number, numberOfTaps: number) => Promise<void>;
